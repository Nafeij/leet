# A simple calculator that can solve expressions with literals and variables.
OPS = {
    '+': lambda a, b: a + b,
    '-': lambda a, b: a - b,
    '*': lambda a, b: a * b,
    ...
    def simplify(self):
        ...
        match (self.left, self.right):
            ...
            case (Term(val=o1, left=l1, right=r1), fac) | (fac, Term(val=o1, left=l1, right=r1)) if (
                ...
                if o1 in ('+', '*'):
                    return l1.opr(o1, r1.opr(self.val, fac)).simplify()
                else:
                    return l1.opr(self.val, r1.opr(o1, fac)).simplify()
            case _:
                return self
